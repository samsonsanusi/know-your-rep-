        ...
        <div className="homepage">
            ...
            <div className="home_question_section">
                <div className="home_question_background">
                    ...
                    <p className="home_para_question">Answer these questions & <span className="home_span">Get N1,000 Voucher</span></p>
                </div>
            </div>
                    ...
                    <div className="card">
                        ...
                        <div className="container">
                            ...
                            <div className="rating">
                                ...
                                <div className="rating_button ">
                                    <img
                                        className="filled_background" src={Oval2} alt="" />
                                </div>
            ...
            <div className="reps view_all">
                <div className="colored_arrow"><img src={keyboard_backspace} alt="" /></div>
                ...
                <div className="reps footer_footer">
                    ...
                    <div className="footer_white_bg">
                        <div className="home_footer_content">
                            ...
                            <div className="inner_footer_content">
                                ...
                                <p className="inner_footer_content_para2">Target: <span className="home_footer_number">100,000</span></p>
                            </div>
                            <div className="progress_bar" style={{ width: 300 }}>
                                <Progress percent={50} size="small" status="active" strokeColor={{
                                    '0%': '#D9A01B',
                                    '100%': '#D9A01B',
                                }} percent={80} />
                            </div>
                    ...
                    <div className="footer_white_bg">
                        <div className="home_footer_content">
                            ...
                            <div className="progress_bar" style={{ width: 300 }}>
                                <Progress percent={80} size="small" status="active" strokeColor={{
                                    '0%': '#D9A01B',
                                    '100%': '#D9A01B',
                                }} percent={80} />
                            </div>
                    ...
                    <div className="footer_white_bg">
                        <div className="home_footer_content">
                            ...
                            <div className="progress_bar" style={{ width: 300 }}>
                                <Progress percent={40} size="small" status="active" strokeColor={{
                                    '0%': '#D9A01B',
                                    '100%': '#D9A01B',
                                }} percent={40} />
                            </div>
